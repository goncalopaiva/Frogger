...
export PACKAGE=rmi
export QUEUE_NAME_PREFIX=froggerMQ
export EXCHANGE_NAME_PREFIX=NA
export PRODUCER_CLASS_PREFIX=Emit
export CONSUMER_CLASS_PREFIX=Receive
...
export JAVASCRIPTSPATH=${RABBITMQ_SERVICES_FOLDER}/${PACKAGE}/runscriptsmq
