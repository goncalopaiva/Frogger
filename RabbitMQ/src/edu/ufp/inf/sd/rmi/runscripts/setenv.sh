...
export JAVAPROJ_NAME=Frogger_RabbitMQ
...
export SERVICE_NAME_ON_REGISTRY=FroggerServer
export CLIENT_CLASS_PREFIX=Frogger
export SERVER_CLASS_PREFIX=Frogger
...
export MYSQL_CON_JAR=jig-1.7.5.jar
...
export JAVA_RABBITMQ_TOOLS=${JAVA_LIB_FOLDER}/amqp-client-5.11.0.jar:${JAVA_LIB_FOLDER}/slf4j-api-1.7.30.jar:${JAVA_LIB_FOLDER}/slf4j-simple-1.7.30.jar:${JAVA_LIB_FOLDER}/jig-1.7.5.jar
