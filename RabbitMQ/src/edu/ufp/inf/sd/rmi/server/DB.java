...
import edu.ufp.inf.sd.rmi.client.ObserverImpl;
...
public class DB extends UnicastRemoteObject {
    ...
    public ArrayList<FroggerClient> clients;

    //public ObserverImpl observer1 = clients.get(0).getObserver();
    //public ObserverImpl observer2 = clients.get(1).getObserver();
    ...
    public FroggerGameRI getGame() {
        return game;
    }

    public void setGame(FroggerGameRI game) {
        this.game = game;
    }
}
